//
//  SLSharedDownloadManager.h
//  SLSharedDownloadManager
//
...
@interface SLSharedDownloadManager : NSObject

/**
 The directory where downloaded files are cached, default is .../Library/Caches/SLSharedDownloadManager if not setted.
 */
