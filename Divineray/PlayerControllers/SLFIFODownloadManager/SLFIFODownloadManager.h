...
@interface SLFIFODownloadManager : NSObject

/**
 The directory where downloaded files are cached, default is .../Library/Caches/SLFIFODownloadManager if not setted.
 */
